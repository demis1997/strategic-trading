...
import type {
  IDeployStrategy,
  IDeployStrategyInterface,
} from "../../../contracts/interfaces/IDeployStrategy";
...
export class IDeployStrategy__factory {
  static readonly abi = _abi;
  static createInterface(): IDeployStrategyInterface {
    return new Interface(_abi) as IDeployStrategyInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IDeployStrategy {
    return new Contract(address, _abi, runner) as unknown as IDeployStrategy;
  }
}
