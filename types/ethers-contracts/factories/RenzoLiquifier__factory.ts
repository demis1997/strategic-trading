...
export class RenzoLiquifier__factory {
  static readonly abi = _abi;
  static createInterface(): RenzoLiquifierInterface {
    return new Interface(_abi) as RenzoLiquifierInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): RenzoLiquifier {
    return new Contract(address, _abi, runner) as unknown as RenzoLiquifier;
  }
}
