...
export interface LidoAdapterInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "setWstETHAddress",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "wstETHAddress",
    values?: undefined
  ): string;
...
export interface LidoAdapter extends BaseContract {
  ...
  getFunction(
    nameOrSignature: "setWstETHAddress"
  ): TypedContractMethod<[wstETHAddress_: AddressLike], [void], "nonpayable">;
  getFunction(
