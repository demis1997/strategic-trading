...
export interface StaderAdapterInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "setETHxAddress",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export interface StaderAdapter extends BaseContract {
  ...
  >;
  getFunction(
    nameOrSignature: "setETHxAddress"
  ): TypedContractMethod<[ethxAddress_: AddressLike], [void], "nonpayable">;
  getFunction(
