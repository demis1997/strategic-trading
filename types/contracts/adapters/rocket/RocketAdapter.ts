...
export interface RocketAdapterInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "rocketSettingsAddress",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "setRETHAddress",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export interface RocketAdapter extends BaseContract {
  ...
  deposit: TypedContractMethod<
    ...
    [[string, bigint] & { liquidTkn: string; liquidTknAmount: bigint }],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "rocketSettingsAddress"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "setRETHAddress"
  ): TypedContractMethod<[rETHAddress_: AddressLike], [void], "nonpayable">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "setprotocolAddress"
  ): TypedContractMethod<[protocolAddress_: AddressLike], [void], "nonpayable">;
  getFunction(
