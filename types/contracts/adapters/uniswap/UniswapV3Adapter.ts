...
export interface UniswapV3AdapterInterface extends Interface {
  getFunction(
    nameOrSignature:
      ...
      | "pause"
      | "paused"
      | "poolsPerTokenForPrice"
      | "protocolName"
      | "renounceRole"
      | "revokeRole"
      | "setPoolPerTokenForPrice"
      | "setSlippage"
      | "setUniswapQuoterAddress"
  ...
  encodeFunctionData(
    functionFragment: "poolsPerTokenForPrice",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setPoolPerTokenForPrice",
    values: [AddressLike, AddressLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setUniswapQuoterAddress",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
    functionFragment: "setUniswapRouterAddress",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export namespace PoolForTokenPriceSetEvent {
...
export interface UniswapV3Adapter extends BaseContract {
  ...
  getAmountInForexactOutput: TypedContractMethod<
    [path_: BytesLike, amountOut_: BigNumberish],
    [[bigint, bigint] & { amountIn: bigint; amountInMaximum: bigint }],
    "nonpayable"
  >;
  ...
  setPoolPerTokenForPrice: TypedContractMethod<
    [token_: AddressLike, pool_: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "poolsPerTokenForPrice"
  ...
  >;
  getFunction(
    nameOrSignature: "setPoolPerTokenForPrice"
  ): TypedContractMethod<
    [token_: AddressLike, pool_: AddressLike],
    [void],
    "nonpayable"
  ...
  getFunction(
    nameOrSignature: "setUniswapQuoterAddress"
  ): TypedContractMethod<[uniswapQuoter_: AddressLike], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "setUniswapRouterAddress"
  ): TypedContractMethod<
    [uniswapRouterAddress_: AddressLike],
    [void],
    "nonpayable"
  >;
  getFunction(
    nameOrSignature: "setWETHAddress"
  ): TypedContractMethod<[wethAddress_: AddressLike], [void], "nonpayable">;
  getFunction(
  ...
  >;
  getEvent(
    key: "PoolForTokenPriceSet"
  ): TypedContractEvent<
    PoolForTokenPriceSetEvent.InputTuple,
    PoolForTokenPriceSetEvent.OutputTuple,
    PoolForTokenPriceSetEvent.OutputObject
  >;
  getEvent(
    key: "Quoted"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "PoolForTokenPriceSet(address,address)": TypedContractEvent<
      PoolForTokenPriceSetEvent.InputTuple,
      PoolForTokenPriceSetEvent.OutputTuple,
      PoolForTokenPriceSetEvent.OutputObject
    >;
    PoolForTokenPriceSet: TypedContractEvent<
      PoolForTokenPriceSetEvent.InputTuple,
      PoolForTokenPriceSetEvent.OutputTuple,
      PoolForTokenPriceSetEvent.OutputObject
    >;

    "Quoted(uint256,uint256,uint256)": TypedContractEvent<
      QuotedEvent.InputTuple,
      QuotedEvent.OutputTuple,
      QuotedEvent.OutputObject
    >;
