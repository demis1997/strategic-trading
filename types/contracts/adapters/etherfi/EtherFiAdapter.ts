...
export interface EtherFiAdapterInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "liquifierAddress",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "setLiquifierAddress",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export interface EtherFiAdapter extends BaseContract {
  ...
  >;
  getFunction(
    nameOrSignature: "liquifierAddress"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "setLiquifierAddress"
  ): TypedContractMethod<
    [liquifierAddress_: AddressLike],
    [void],
    "nonpayable"
