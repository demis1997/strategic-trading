...
export interface UniswapV3RouterMockInterface extends Interface {
  getFunction(
    nameOrSignature: "exactOutput" | "output" | "setExactOutput"
  ): FunctionFragment;

  encodeFunctionData(
    functionFragment: "exactOutput",
    values: [UniswapV3RouterMock.ExactOutputParamsStruct]
  ): string;
  encodeFunctionData(functionFragment: "output", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "setExactOutput",
    values: [BigNumberish]
  ): string;
...
export interface UniswapV3RouterMock extends BaseContract {
  ...
  getFunction(
    nameOrSignature: "setExactOutput"
