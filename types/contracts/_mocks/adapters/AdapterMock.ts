...
export interface AdapterMockInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "returnWrongAddress",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setReturnWrongAddress",
    values: [boolean]
  ): string;
  encodeFunctionData(
...
export interface AdapterMock extends BaseContract {
  ...
  claimEarnings: TypedContractMethod<
    [account_: AddressLike, receiver_: AddressLike],
    [[string, bigint]],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "returnWrongAddress"
  ...
  getFunction(
    nameOrSignature: "setReturnWrongAddress"
