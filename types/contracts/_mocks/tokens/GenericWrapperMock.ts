...
export interface GenericWrapperMockInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "amountToReturn",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setExpectToFail",
    values: [boolean]
  ): string;
  encodeFunctionData(
...
export interface GenericWrapperMock extends BaseContract {
  ...
  >;
  getFunction(
    nameOrSignature: "amountToReturn"
  ...
  getFunction(
    nameOrSignature: "setAmountToReturn"
  ): TypedContractMethod<[amountToReturn_: BigNumberish], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "setDecimals"
  ): TypedContractMethod<[value: BigNumberish], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "setExpectToFail"
