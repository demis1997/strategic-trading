...
export interface DepositStrategyMockInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "liquidToken",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "liquidTokenAmount",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setDeployedAssetsValue",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setTokenAmounts",
...
export interface DepositStrategyMock extends BaseContract {
  ...
  setTokenAddress: TypedContractMethod<
    [tokenAddress_: AddressLike, target_: BigNumberish],
    [void],
    "nonpayable"
  >;

  setTokenAmounts: TypedContractMethod<
    [amount_: BigNumberish, target_: BigNumberish],
    [void],
    "nonpayable"
  >;

  setTokenPrice: TypedContractMethod<
    [tokenPrice_: BigNumberish, target_: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "liquidToken"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "liquidTokenAmount"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "setDeployedAssetsValue"
  ...
  >;
  getFunction(
    nameOrSignature: "setTokenAmounts"
  ): TypedContractMethod<
    [amount_: BigNumberish, target_: BigNumberish],
    [void],
    "nonpayable"
