...
export interface VaultMockInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "getVaultValuation",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "totalAssetsValue",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface VaultMock extends BaseContract {
  ...
  deposit: TypedContractMethod<
    [assetsAmount_: BigNumberish, account_: AddressLike],
    [bigint],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "getVaultValuation"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "totalAssetsValue"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
