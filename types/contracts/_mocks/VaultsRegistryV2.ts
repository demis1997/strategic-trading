...
export interface VaultsRegistryV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "BASE"
      | "DEFAULT_ADMIN_ROLE"
      | "addedMethodRegistryV2"
      | "addedVariableRegistryV2"
      | "defaultFeeRate"
      | "deployVault"
      | "getRoleAdmin"
  ...
  encodeFunctionData(
    functionFragment: "addedMethodRegistryV2",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "addedVariableRegistryV2",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface VaultsRegistryV2 extends BaseContract {
  ...
  getFunction(
    nameOrSignature: "addedMethodRegistryV2"
  ): TypedContractMethod<[_newValue: BigNumberish], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "addedVariableRegistryV2"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
