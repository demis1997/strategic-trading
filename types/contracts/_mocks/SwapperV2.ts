...
export interface SwapperV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "SWAPPER_EXECUTOR"
  ...
  encodeFunctionData(
    functionFragment: "newFunctionality",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface SwapperV2 extends BaseContract {
  connect(runner?: ContractRunner | null): SwapperV2;
  ...
  newFunctionality: TypedContractMethod<[], [string], "view">;
  ...
  >;
  getFunction(
    nameOrSignature: "newFunctionality"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
