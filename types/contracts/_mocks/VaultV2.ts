...
export interface VaultV2Interface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "addedMethodVaultV2",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "addedVariableVaultV2",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface VaultV2 extends BaseContract {
  ...
  getFunction(
    nameOrSignature: "addedMethodVaultV2"
  ): TypedContractMethod<[_newValue: BigNumberish], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "addedVariableVaultV2"
