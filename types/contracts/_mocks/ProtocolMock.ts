...
export declare namespace ProtocolMock {
...
export interface ProtocolMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "assetAddress"
  ...
  encodeFunctionData(
    ...
    values: [ProtocolMock.ExactOutputParamsStruct]
  ): string;
  encodeFunctionData(
...
export interface ProtocolMock extends BaseContract {
  connect(runner?: ContractRunner | null): ProtocolMock;
  waitForDeployment(): Promise<this>;

  interface: ProtocolMockInterface;
  ...
  exactOutput: TypedContractMethod<
    [params: ProtocolMock.ExactOutputParamsStruct],
    [bigint],
    "payable"
  >;
