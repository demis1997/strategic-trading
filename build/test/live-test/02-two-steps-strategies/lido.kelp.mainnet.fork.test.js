...
describe("LIDO - KELP ==> Restaking Strategy Tests -->> LIVE TESTS", function () {
    ...
    before(async () => {
        ...
        strategyContract = (await (0, _deployContracts_1.deployVaultStrategy)("StrSimpleReStaking", vaultAddress, constants_1.KELP_rsETH_ADDRESS, [lidoAdapterContractAddress, kelpAdapterContractAddress], [uniswapAdapterContractAddress], "Simple Re-Staking Strategy"));
        ...
        deltaKelp = await (0, utils_1.getDelta)(constants_1.LIDO_stETH_ADDRESS, constants_1.KELP_rsETH_ADDRESS, deployer, deltaLido.outAmount, kelpAdapterContract);
        ...
        expectedBalanceAferDeployment = (deltaLido.outAmount * constants_1.AMOUNT_1E18) / deltaKelp.delta;
...
//# sourceMappingURL=lido.kelp.mainnet.fork.test.js.map