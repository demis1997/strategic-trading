...
export declare class RETH__factory {
    static readonly abi: readonly [{
        readonly inputs: readonly [{
            readonly internalType: "contract RocketStorageInterface";
            readonly name: "_rocketStorageAddress";
    ...
    static connect(address: string, runner?: ContractRunner | null): RETH;
}
//# sourceMappingURL=RETH__factory.d.ts.map