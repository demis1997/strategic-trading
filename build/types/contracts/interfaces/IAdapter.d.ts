...
export interface IAdapterInterface extends Interface {
    getFunction(nameOrSignature: "claimEarnings" | "deposit" | "getProtocol" | "getSlippage" | "getTokenPrice" | "withdraw"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "AddressUpdated" | "DepositedOnProtocol" | "SlippageUpdated" | "WithdrawFromProtocol"): EventFragment;
