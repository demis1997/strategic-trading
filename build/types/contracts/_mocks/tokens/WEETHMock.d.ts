...
export interface WEETHMockInterface extends Interface {
    getFunction(nameOrSignature: "_balances" | "allowance" | "approve" | "balanceOf" | "burnFrom" | "decimals" | "decreaseAllowance" | "eETH" | "increaseAllowance" | "mint" | "mockBalanceOf" | "name" | "setDecimals" | "setIsSafeApprove" | "setNeedToReturnValue" | "setReturnBoolValue" | "setTokenPerShare" | "stEthPerToken" | "symbol" | "tokensPerStEth" | "totalSupply" | "transfer" | "transferFrom" | "wrap"): FunctionFragment;
...
export interface WEETHMock extends BaseContract {
    connect(runner?: ContractRunner | null): WEETHMock;
    waitForDeployment(): Promise<this>;
    interface: WEETHMockInterface;
    ...
    getFunction(nameOrSignature: "eETH"): TypedContractMethod<[], [string], "view">;
...
//# sourceMappingURL=WEETHMock.d.ts.map