...
export interface UniswapV3QuoterMockInterface extends Interface {
    getFunction(nameOrSignature: "amountIn" | "quoteExactOutput" | "setQuoteExactOutput"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "setQuoteExactOutput", values: [BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "setQuoteExactOutput", data: BytesLike): Result;
}
export interface UniswapV3QuoterMock extends BaseContract {
    ...
    getFunction(nameOrSignature: "amountIn"): TypedContractMethod<[], [bigint], "view">;
    ...
    getFunction(nameOrSignature: "setQuoteExactOutput"): TypedContractMethod<[amountIn_: BigNumberish], [void], "nonpayable">;
    filters: {};
}
//# sourceMappingURL=UniswapV3QuoterMock.d.ts.map