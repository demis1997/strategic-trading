...
export interface AggregatorTokenInterface extends Interface {
    getFunction(nameOrSignature: "DEFAULT_ADMIN_ROLE" | "FEE_MANAGER_ROLE" | "LYSADMIN_MANAGER_ROLE" | "TRANSFERS_MANAGER_ROLE" | "VALUATIONS_MANAGER_ROLE" | "VAULTS_MANAGER_ROLE" | "aggregatorFeeModel" | "allowance" | "approve" | "balanceOf" | "currentAssetsPerVault" | "currentSharesPerVault" | "decimals" | "deposit" | "depositFailureMode" | "exchangeRate" | "getPortfolioLastExchangeRate" | "getRoleAdmin" | "getUnderlyingAsset" | "grantRole" | "hasRole" | "initialize" | "lastAssetsPerVault" | "lastSharesPerVault" | "maxVaultsPerHolder" | "name" | "numberOfVaults" | "pause" | "paused" | "renounceRole" | "revokeRole" | "setAggregatorFeeModel" | "setMaxVaultsPerHolder" | "setTransferStrategy" | "supportsInterface" | "symbol" | "totalSupply" | "transfer" | "transferFrom" | "transferStrategy" | "underlyingAsset" | "underlyingValue" | "unpause" | "updatePortfolioValuation" | "vaultsOf" | "vaultsRegistry" | "vaultsShares" | "withdraw" | "withdrawalMode"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "currentAssetsPerVault", values: [AddressLike]): string;
    ...
    encodeFunctionData(functionFragment: "depositFailureMode", values?: undefined): string;
    encodeFunctionData(functionFragment: "exchangeRate", values?: undefined): string;
    encodeFunctionData(functionFragment: "getPortfolioLastExchangeRate", values: [AddressLike]): string;
    ...
    encodeFunctionData(functionFragment: "initialize", values: [AddressLike, AddressLike, AddressLike, string, string]): string;
    encodeFunctionData(functionFragment: "lastAssetsPerVault", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "lastSharesPerVault", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "maxVaultsPerHolder", values?: undefined): string;
    encodeFunctionData(functionFragment: "name", values?: undefined): string;
    encodeFunctionData(functionFragment: "numberOfVaults", values: [AddressLike]): string;
    ...
    encodeFunctionData(functionFragment: "withdrawalMode", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "currentAssetsPerVault", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "currentSharesPerVault", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "decimals", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "deposit", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "depositFailureMode", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "exchangeRate", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getPortfolioLastExchangeRate", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "lastAssetsPerVault", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "lastSharesPerVault", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "maxVaultsPerHolder", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "name", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "numberOfVaults", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "withdrawalMode", data: BytesLike): Result;
}
...
export interface AggregatorToken extends BaseContract {
    connect(runner?: ContractRunner | null): AggregatorToken;
    waitForDeployment(): Promise<this>;
    interface: AggregatorTokenInterface;
    ...
    currentAssetsPerVault: TypedContractMethod<[
    ...
    depositFailureMode: TypedContractMethod<[], [bigint], "view">;
    exchangeRate: TypedContractMethod<[], [bigint], "view">;
    getPortfolioLastExchangeRate: TypedContractMethod<[
        tokenHolder_: AddressLike
    ], [
        bigint
    ], "view">;
    ...
    initialize: TypedContractMethod<[
        underlyingAsset_: AddressLike,
        vaultsRegistry_: AddressLike,
    ...
    lastAssetsPerVault: TypedContractMethod<[
        tokenHolder_: AddressLike
    ], [
        [string[], bigint[]] & {
            vaults: string[];
    ...
    lastSharesPerVault: TypedContractMethod<[
        tokenHolder_: AddressLike
    ], [
        [string[], bigint[]] & {
            vaults: string[];
    ...
    numberOfVaults: TypedContractMethod<[
        tokenHolder_: AddressLike
    ], [
        bigint
    ], "view">;
    ...
    withdrawalMode: TypedContractMethod<[], [bigint], "view">;
    ...
    getFunction(nameOrSignature: "balanceOf"): TypedContractMethod<[account_: AddressLike], [bigint], "view">;
    getFunction(nameOrSignature: "currentAssetsPerVault"): TypedContractMethod<[
        tokenHolder_: AddressLike
    ], [
        [string[], bigint[]] & {
            vaults: string[];
    ...
    getFunction(nameOrSignature: "depositFailureMode"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "exchangeRate"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "getPortfolioLastExchangeRate"): TypedContractMethod<[tokenHolder_: AddressLike], [bigint], "view">;
    ...
    getFunction(nameOrSignature: "lastAssetsPerVault"): TypedContractMethod<[
        tokenHolder_: AddressLike
    ], [
        [string[], bigint[]] & {
            vaults: string[];
    ...
    getFunction(nameOrSignature: "lastSharesPerVault"): TypedContractMethod<[
        tokenHolder_: AddressLike
    ], [
        [string[], bigint[]] & {
            vaults: string[];
    ...
    getFunction(nameOrSignature: "numberOfVaults"): TypedContractMethod<[tokenHolder_: AddressLike], [bigint], "view">;
    ...
    getFunction(nameOrSignature: "withdrawalMode"): TypedContractMethod<[], [bigint], "view">;
...
//# sourceMappingURL=AggregatorToken.d.ts.map