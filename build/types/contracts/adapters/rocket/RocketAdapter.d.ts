...
export interface RocketAdapterInterface extends Interface {
    getFunction(nameOrSignature: "DEFAULT_ADMIN_ROLE" | "REVERT_MSG" | "VAULT_STRATEGY_ROLE" | "claimEarnings" | "deposit" | "getProtocol" | "getRoleAdmin" | "getSlippage" | "getTokenPrice" | "grantRole" | "hasRole" | "initialize" | "pause" | "paused" | "protocolAddress" | "protocolName" | "rETHAddress" | "renounceRole" | "revokeRole" | "rocketSettingsAddress" | "setRETHAddress" | "setSlippage" | "setWETHAddress" | "setprotocolAddress" | "slippage" | "supportsInterface" | "unpause" | "wethAddress" | "withdraw"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "rETHAddress", values?: undefined): string;
    encodeFunctionData(functionFragment: "renounceRole", values: [BytesLike, AddressLike]): string;
    encodeFunctionData(functionFragment: "revokeRole", values: [BytesLike, AddressLike]): string;
    encodeFunctionData(functionFragment: "rocketSettingsAddress", values?: undefined): string;
    encodeFunctionData(functionFragment: "setRETHAddress", values: [AddressLike]): string;
    ...
    decodeFunctionResult(functionFragment: "rETHAddress", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "renounceRole", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "revokeRole", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "rocketSettingsAddress", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setRETHAddress", data: BytesLike): Result;
...
export interface RocketAdapter extends BaseContract {
    connect(runner?: ContractRunner | null): RocketAdapter;
    waitForDeployment(): Promise<this>;
    interface: RocketAdapterInterface;
    ...
    initialize: TypedContractMethod<[
        ...
        rocketSettingsAddress_: AddressLike,
        wethAddress_: AddressLike,
        rETHAddress_: AddressLike
    ], [
        void
    ], "nonpayable">;
    ...
    rETHAddress: TypedContractMethod<[], [string], "view">;
    ...
    rocketSettingsAddress: TypedContractMethod<[], [string], "view">;
    setRETHAddress: TypedContractMethod<[
        rETHAddress_: AddressLike
    ], [
        void
    ], "nonpayable">;
    ...
    getFunction(nameOrSignature: "rETHAddress"): TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "rocketSettingsAddress"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "setRETHAddress"): TypedContractMethod<[rETHAddress_: AddressLike], [void], "nonpayable">;
...
//# sourceMappingURL=RocketAdapter.d.ts.map