...
export interface FraxAdapterInterface extends Interface {
    getFunction(nameOrSignature: "DEFAULT_ADMIN_ROLE" | "REVERT_MSG" | "VAULT_STRATEGY_ROLE" | "claimEarnings" | "deposit" | "frxETHAddress" | "getProtocol" | "getRoleAdmin" | "getSlippage" | "getTokenPrice" | "grantRole" | "hasRole" | "initialize" | "minterAddress" | "pause" | "paused" | "protocolName" | "renounceRole" | "revokeRole" | "setFrxETHAddress" | "setMinterAddress" | "setSfrxETHAddress" | "setSlippage" | "setWETHAddress" | "sfrxETHAddress" | "slippage" | "supportsInterface" | "unpause" | "wethAddress" | "withdraw"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "frxETHAddress", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "setFrxETHAddress", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "setMinterAddress", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "setSfrxETHAddress", values: [AddressLike]): string;
    ...
    encodeFunctionData(functionFragment: "sfrxETHAddress", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "frxETHAddress", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setFrxETHAddress", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setMinterAddress", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setSfrxETHAddress", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "sfrxETHAddress", data: BytesLike): Result;
...
export interface FraxAdapter extends BaseContract {
    connect(runner?: ContractRunner | null): FraxAdapter;
    ...
    frxETHAddress: TypedContractMethod<[], [string], "view">;
    ...
    initialize: TypedContractMethod<[
        minterAddress_: AddressLike,
        frxETHAddress_: AddressLike,
        sfrxETHAddress_: AddressLike
    ], [
        void
    ], "nonpayable">;
    ...
    setFrxETHAddress: TypedContractMethod<[
        frxETHAddress_: AddressLike
    ], [
        void
    ], "nonpayable">;
    setMinterAddress: TypedContractMethod<[
        minterAddress_: AddressLike
    ], [
        void
    ], "nonpayable">;
    setSfrxETHAddress: TypedContractMethod<[
        sfrxETHAddress_: AddressLike
    ], [
        void
    ], "nonpayable">;
    ...
    sfrxETHAddress: TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "frxETHAddress"): TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "minterAddress"): TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "setFrxETHAddress"): TypedContractMethod<[frxETHAddress_: AddressLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "setMinterAddress"): TypedContractMethod<[minterAddress_: AddressLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "setSfrxETHAddress"): TypedContractMethod<[sfrxETHAddress_: AddressLike], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "sfrxETHAddress"): TypedContractMethod<[], [string], "view">;
...
//# sourceMappingURL=FraxAdapter.d.ts.map