...
export interface RenzoAdapterInterface extends Interface {
    getFunction(nameOrSignature: "DEFAULT_ADMIN_ROLE" | "REVERT_MSG" | "VAULT_STRATEGY_ROLE" | "claimEarnings" | "deposit" | "ezETHAddress" | "getProtocol" | "getRoleAdmin" | "getSlippage" | "getTokenPrice" | "grantRole" | "hasRole" | "initialize" | "liquifierAddress" | "pause" | "paused" | "protocolName" | "renounceRole" | "revokeRole" | "setLiquifierAddress" | "setSlippage" | "setWETHAddress" | "slippage" | "stETHAddress" | "supportsInterface" | "unpause" | "wethAddress" | "withdraw"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "AddressUpdated" | "DepositedOnProtocol" | "Initialized" | "LogDebugInfo" | "Paused" | "RoleAdminChanged" | "RoleGranted" | "RoleRevoked" | "SlippageUpdated" | "Unpaused" | "WithdrawFromProtocol"): EventFragment;
    ...
    encodeFunctionData(functionFragment: "ezETHAddress", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "liquifierAddress", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "setLiquifierAddress", values: [AddressLike]): string;
    ...
    encodeFunctionData(functionFragment: "stETHAddress", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "ezETHAddress", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "liquifierAddress", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setLiquifierAddress", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "stETHAddress", data: BytesLike): Result;
...
export declare namespace LogDebugInfoEvent {
    type InputTuple = [info: string, value: BigNumberish];
    type OutputTuple = [info: string, value: bigint];
    interface OutputObject {
        info: string;
        value: bigint;
    }
...
export interface RenzoAdapter extends BaseContract {
    connect(runner?: ContractRunner | null): RenzoAdapter;
    waitForDeployment(): Promise<this>;
    interface: RenzoAdapterInterface;
    ...
    ezETHAddress: TypedContractMethod<[], [string], "view">;
    ...
    initialize: TypedContractMethod<[
        liquifierAddress_: AddressLike,
        ezETHAddress_: AddressLike,
        stETHAddress_: AddressLike
    ], [
        void
    ], "nonpayable">;
    liquifierAddress: TypedContractMethod<[], [string], "view">;
    ...
    setLiquifierAddress: TypedContractMethod<[
        liquifierAddress_: AddressLike
    ], [
        void
    ], "nonpayable">;
    ...
    stETHAddress: TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "ezETHAddress"): TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "liquifierAddress"): TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "setLiquifierAddress"): TypedContractMethod<[
        liquifierAddress_: AddressLike
    ], [
        void
    ], "nonpayable">;
    ...
    getFunction(nameOrSignature: "stETHAddress"): TypedContractMethod<[], [string], "view">;
    ...
    getEvent(key: "LogDebugInfo"): TypedContractEvent<LogDebugInfoEvent.InputTuple, LogDebugInfoEvent.OutputTuple, LogDebugInfoEvent.OutputObject>;
    ...
    filters: {
        ...
        "LogDebugInfo(string,uint256)": TypedContractEvent<LogDebugInfoEvent.InputTuple, LogDebugInfoEvent.OutputTuple, LogDebugInfoEvent.OutputObject>;
        LogDebugInfo: TypedContractEvent<LogDebugInfoEvent.InputTuple, LogDebugInfoEvent.OutputTuple, LogDebugInfoEvent.OutputObject>;
...
//# sourceMappingURL=RenzoAdapter.d.ts.map