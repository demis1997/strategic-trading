...
export interface StaderAdapterInterface extends Interface {
    getFunction(nameOrSignature: "DEFAULT_ADMIN_ROLE" | "REVERT_MSG" | "VAULT_STRATEGY_ROLE" | "claimEarnings" | "deposit" | "ethxAddress" | "getProtocol" | "getRoleAdmin" | "getSlippage" | "getTokenPrice" | "grantRole" | "hasRole" | "initialize" | "pause" | "paused" | "protocolAddress" | "protocolName" | "renounceRole" | "revokeRole" | "setETHxAddress" | "setSlippage" | "setWETHAddress" | "setprotocolAddress" | "slippage" | "supportsInterface" | "unpause" | "wethAddress" | "withdraw"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "ethxAddress", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "setETHxAddress", values: [AddressLike]): string;
    ...
    decodeFunctionResult(functionFragment: "ethxAddress", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setETHxAddress", data: BytesLike): Result;
...
export interface StaderAdapter extends BaseContract {
    connect(runner?: ContractRunner | null): StaderAdapter;
    waitForDeployment(): Promise<this>;
    interface: StaderAdapterInterface;
    ...
    ethxAddress: TypedContractMethod<[], [string], "view">;
    ...
    setETHxAddress: TypedContractMethod<[
        ethxAddress_: AddressLike
    ], [
        void
    ], "nonpayable">;
    ...
    getFunction(nameOrSignature: "ethxAddress"): TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "setETHxAddress"): TypedContractMethod<[ethxAddress_: AddressLike], [void], "nonpayable">;
...
//# sourceMappingURL=StaderAdapter.d.ts.map