...
export interface KelpAdapterInterface extends Interface {
    getFunction(nameOrSignature: "DEFAULT_ADMIN_ROLE" | "REVERT_MSG" | "VAULT_STRATEGY_ROLE" | "claimEarnings" | "deposit" | "getProtocol" | "getRoleAdmin" | "getSlippage" | "getTokenPrice" | "grantRole" | "hasRole" | "initialize" | "kelpProtocolAddress" | "pause" | "paused" | "protocolName" | "renounceRole" | "revokeRole" | "rsETHAddress" | "setKelpProtocolAddress" | "setSlippage" | "setWETHAddress" | "slippage" | "supportsInterface" | "unpause" | "wethAddress" | "withdraw"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "kelpProtocolAddress", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "rsETHAddress", values?: undefined): string;
    encodeFunctionData(functionFragment: "setKelpProtocolAddress", values: [AddressLike]): string;
    ...
    decodeFunctionResult(functionFragment: "kelpProtocolAddress", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "rsETHAddress", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setKelpProtocolAddress", data: BytesLike): Result;
...
export interface KelpAdapter extends BaseContract {
    connect(runner?: ContractRunner | null): KelpAdapter;
    waitForDeployment(): Promise<this>;
    interface: KelpAdapterInterface;
    ...
    initialize: TypedContractMethod<[
        kelpProtocolAddress_: AddressLike,
        rsETHAddress_: AddressLike
    ], [
        void
    ], "nonpayable">;
    kelpProtocolAddress: TypedContractMethod<[], [string], "view">;
    ...
    rsETHAddress: TypedContractMethod<[], [string], "view">;
    setKelpProtocolAddress: TypedContractMethod<[
        kelpProtocolAddress_: AddressLike
    ], [
        void
    ], "nonpayable">;
    ...
    getFunction(nameOrSignature: "kelpProtocolAddress"): TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "rsETHAddress"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "setKelpProtocolAddress"): TypedContractMethod<[
        kelpProtocolAddress_: AddressLike
    ], [
        void
    ], "nonpayable">;
...
//# sourceMappingURL=KelpAdapter.d.ts.map