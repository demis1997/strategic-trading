...
export interface IKelpProtocolInterface extends Interface {
    getFunction(nameOrSignature: "depositAsset" | "getAssetCurrentLimit" | "getRsETHAmountToMint" | "minAmountToDeposit"): FunctionFragment;
...
export interface IKelpProtocol extends BaseContract {
    ...
    getFunction(nameOrSignature: "getAssetCurrentLimit"): TypedContractMethod<[asset: AddressLike], [bigint], "view">;
...
//# sourceMappingURL=IKelpProtocol.d.ts.map