...
export interface UniswapV3AdapterInterface extends Interface {
    getFunction(nameOrSignature: "DEFAULT_ADMIN_ROLE" | "REVERT_MSG" | "VAULT_STRATEGY_ROLE" | "claimEarnings" | "deposit" | "getAmountInForexactOutput" | "getProtocol" | "getRoleAdmin" | "getSlippage" | "getTokenPrice" | "grantRole" | "hasRole" | "initialize" | "pause" | "paused" | "poolsPerTokenForPrice" | "protocolName" | "renounceRole" | "revokeRole" | "setPoolPerTokenForPrice" | "setSlippage" | "setUniswapQuoterAddress" | "setUniswapRouterAddress" | "setWETHAddress" | "slippage" | "supportsInterface" | "uniswapQuoter" | "uniswapV3Router" | "unpause" | "wethAddress" | "withdraw"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "AddressUpdated" | "DepositedOnProtocol" | "Initialized" | "Paused" | "PoolForTokenPriceSet" | "Quoted" | "RoleAdminChanged" | "RoleGranted" | "RoleRevoked" | "SlippageUpdated" | "Unpaused" | "WithdrawFromProtocol"): EventFragment;
    ...
    encodeFunctionData(functionFragment: "poolsPerTokenForPrice", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "protocolName", values?: undefined): string;
    encodeFunctionData(functionFragment: "renounceRole", values: [BytesLike, AddressLike]): string;
    encodeFunctionData(functionFragment: "revokeRole", values: [BytesLike, AddressLike]): string;
    encodeFunctionData(functionFragment: "setPoolPerTokenForPrice", values: [AddressLike, AddressLike]): string;
    encodeFunctionData(functionFragment: "setSlippage", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "setUniswapQuoterAddress", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "setUniswapRouterAddress", values: [AddressLike]): string;
    ...
    encodeFunctionData(functionFragment: "uniswapQuoter", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "poolsPerTokenForPrice", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "protocolName", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "renounceRole", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "revokeRole", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setPoolPerTokenForPrice", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setSlippage", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setUniswapQuoterAddress", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setUniswapRouterAddress", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "uniswapQuoter", data: BytesLike): Result;
...
export declare namespace PoolForTokenPriceSetEvent {
    type InputTuple = [token: AddressLike, pool: AddressLike];
    type OutputTuple = [token: string, pool: string];
    interface OutputObject {
        token: string;
        pool: string;
    }
...
export declare namespace QuotedEvent {
    type InputTuple = [
...
export interface UniswapV3Adapter extends BaseContract {
    ...
    initialize: TypedContractMethod<[
        uniswapV3Router_: AddressLike,
        uniswapQuoter_: AddressLike,
    ...
    poolsPerTokenForPrice: TypedContractMethod<[
        token: AddressLike
    ], [
        string
    ], "view">;
    ...
    setPoolPerTokenForPrice: TypedContractMethod<[
        token_: AddressLike,
        pool_: AddressLike
    ], [
        void
    ...
    setUniswapQuoterAddress: TypedContractMethod<[
        uniswapQuoter_: AddressLike
    ], [
        void
    ], "nonpayable">;
    setUniswapRouterAddress: TypedContractMethod<[
        uniswapRouterAddress_: AddressLike
    ], [
        void
    ], "nonpayable">;
    ...
    getFunction(nameOrSignature: "poolsPerTokenForPrice"): TypedContractMethod<[token: AddressLike], [string], "view">;
    ...
    getFunction(nameOrSignature: "setPoolPerTokenForPrice"): TypedContractMethod<[
        token_: AddressLike,
        pool_: AddressLike
    ], [
        void
    ...
    getFunction(nameOrSignature: "setUniswapQuoterAddress"): TypedContractMethod<[uniswapQuoter_: AddressLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "setUniswapRouterAddress"): TypedContractMethod<[
        uniswapRouterAddress_: AddressLike
    ], [
        void
    ], "nonpayable">;
    ...
    getFunction(nameOrSignature: "uniswapQuoter"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "uniswapV3Router"): TypedContractMethod<[], [string], "view">;
    ...
    getEvent(key: "PoolForTokenPriceSet"): TypedContractEvent<PoolForTokenPriceSetEvent.InputTuple, PoolForTokenPriceSetEvent.OutputTuple, PoolForTokenPriceSetEvent.OutputObject>;
    getEvent(key: "Quoted"): TypedContractEvent<QuotedEvent.InputTuple, QuotedEvent.OutputTuple, QuotedEvent.OutputObject>;
    ...
    filters: {
        ...
        "PoolForTokenPriceSet(address,address)": TypedContractEvent<PoolForTokenPriceSetEvent.InputTuple, PoolForTokenPriceSetEvent.OutputTuple, PoolForTokenPriceSetEvent.OutputObject>;
        PoolForTokenPriceSet: TypedContractEvent<PoolForTokenPriceSetEvent.InputTuple, PoolForTokenPriceSetEvent.OutputTuple, PoolForTokenPriceSetEvent.OutputObject>;
        "Quoted(uint256,uint256,uint256)": TypedContractEvent<QuotedEvent.InputTuple, QuotedEvent.OutputTuple, QuotedEvent.OutputObject>;
        Quoted: TypedContractEvent<QuotedEvent.InputTuple, QuotedEvent.OutputTuple, QuotedEvent.OutputObject>;
...
//# sourceMappingURL=UniswapV3Adapter.d.ts.map