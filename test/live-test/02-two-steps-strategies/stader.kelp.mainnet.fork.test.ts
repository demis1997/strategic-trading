...
describe("STADER - KELP ==> Restaking Strategy Tests -->> LIVE TESTS", function () {
    ...
    before(async () => {
        ...
        await uniswapAdapterContract.setPoolPerTokenForPrice(KELP_rsETH_ADDRESS, ETHx_WETH_POOL);
        ...
        // get from lido
        deltaStader = await getDelta(
            WETH_ADDRESS,
            STADER_ETHx_ADDRESS,
            deployer,
            AMOUNT_IN,
            staderAdapterContract as unknown as Contract,
        );
        ...
        expectedBalanceAferDeployment = (deltaStader.outAmount * AMOUNT_1E18) / deltaKelp.delta;
        // calculate initial valuation
        expectedInitialValuation = (expectedBalanceAferDeployment * oneRsETHinWETH) / AMOUNT_1E18;

        // console.log("\n");
        // console.log("DELTA Stad  :>> ", deltaStader);
